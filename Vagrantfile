...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "mhendersonv1-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/mhendersonv1"
  #   chef.validation_client_name = "mhendersonv1-validator"
  #   chef.validation_key_path = ".chef/mhendersonv1-validator.pem"
  # end
end
